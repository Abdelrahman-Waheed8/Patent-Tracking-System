...
class disclosureModel extends DBH
{
    protected function setDisclosure($title, $description, $contributors, $files, $priorArt, $companyNames, $jurisdictionalType, $scope)
    {
        ...
        if (!empty($files)) {
            ...
            $stmtDoc = $pdo->prepare("INSERT INTO document (evidence_ID, filePath, docType, original_name, `Version`) VALUES (:ev_id, :f_path, :ext, :orig_name, :vrsn)");
            ...
            foreach ($files as $file) {
                ...
                $stmtDoc->bindParam(":vrsn", $newVersion);
                $stmtDoc->execute();
            }
        }
